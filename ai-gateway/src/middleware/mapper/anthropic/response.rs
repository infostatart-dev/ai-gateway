...
impl TryConvert<anthropic::CreateMessageResponse, openai::CreateChatCompletionResponse> for super::AnthropicConverter {
    type Error = MapperError;

    fn try_convert(&self, value: anthropic::CreateMessageResponse) -> Result<openai::CreateChatCompletionResponse, Self::Error> {
        let id = value.id;
        ...
        for anthropic_content in value.content {
            match anthropic_content {
                ...
                anthropic::ContentBlock::ToolResult { tool_use_id, content: tool_content } => {
                    tool_calls.push(openai::ChatCompletionMessageToolCalls::Function(openai::ChatCompletionMessageToolCall {
...
impl TryConvert<anthropic::CreateMessageResponse, anthropic::CreateMessageResponse> for super::AnthropicConverter {
    type Error = MapperError;
    fn try_convert(&self, value: anthropic::CreateMessageResponse) -> Result<anthropic::CreateMessageResponse, Self::Error> {
        Ok(value)
    }
}
