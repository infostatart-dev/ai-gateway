...
pub use crate::{
    ...
    router::{
        budget_aware::{
            CredentialHealthRegistry, GatewayRouteMemory, RouteBinding,
            RouteMemoryKey, RouteStreamMode, chatgpt_candidate,
            ...
            plan::{
                plan_route_chain, score::hash_bias, snapshot::QuotaSnapshot,
            },
        },
