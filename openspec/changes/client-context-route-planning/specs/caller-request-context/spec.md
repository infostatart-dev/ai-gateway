...
Normalize inbound invoker identity from HTTP headers so autodefault routing can
distinguish parallel work units (structured calls, chat turns, batch jobs) and
attribute observability per invoker.
