# deepseek-web-context-chunking

## Purpose

Long-context handling for DeepSeek Web via multi-turn context upload on a single
chat session, PoW caching, per-turn pacing, and route trace observability.
