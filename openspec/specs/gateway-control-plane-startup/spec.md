# gateway-control-plane-startup

## Purpose

Sidecar and local dev startup must not block HTTP on an external Helicone control-plane
websocket. Infostart-owned control plane is deferred; routing and autodefault work without
port 8585.
