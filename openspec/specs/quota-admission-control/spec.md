...
Hierarchical upstream admission on `PacingScope`: catalog-driven feasibility, strict
skip without sleep-probe, hop-time re-admit, upstream reconcile, and repeat-429 guard.
