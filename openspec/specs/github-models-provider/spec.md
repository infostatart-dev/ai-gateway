...
Expose GitHub Models inference as an OpenAI-compatible `github-models` provider
using a GitHub PAT (`models:read`), static GitHub API headers, a curated model
catalog with publisher-prefixed upstream IDs, and credential-gated autodefault
placement.
